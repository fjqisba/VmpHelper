...
class VmpHandlerCacheException :public Exception
{
public:
    VmpHandlerCacheException(const char* message) :Exception(message) {};
    VmpHandlerCacheException(const std::string& message) :Exception(message) {};
};